#!/usr/bin/env python3
"""Verify the five Stream H coordinated v0.3 PDF projections."""
...
PAPERS = [
    ("Knowledge", "Knowledge/SymK_Foundation_Paper_Knowledge_v0.3"),
    ("Intelligence", "Intelligence/SymK_Foundation_Paper_Intelligence_v0.3"),
    ("Education and Training", "Education_and_Training/SymK_Foundation_Paper_Education_for_Cooperation_v0.3"),
    ("Knowledge Engineering", "Knowledge_Engineering/SymK_Foundation_Paper_Knowledge_Engineering_v0.3"),
    ("Reader Orientation and Shared Glossary", "Reader_Orientation/SymK_Reader_Orientation_and_Shared_Glossary_v0.3"),
]
...
def main() -> int:
    ...
    for paper, relative_stem in PAPERS:
        ...
        metadata_ok = (
            ...
            and metadata.subject == "Governed Foundation Paper v0.3 review draft; Stream H projection"
        )
