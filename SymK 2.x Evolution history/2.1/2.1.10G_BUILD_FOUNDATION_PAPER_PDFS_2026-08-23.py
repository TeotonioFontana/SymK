#!/usr/bin/env python3
"""Build the four governed SymK v0.2 Markdown review drafts as PDF projections."""
...
PAPERS = [
    {
        "key": "knowledge",
        "source": "00_GOVERNANCE/01_Product_Vision/01_FOUNDATION/Knowledge/SymK_Foundation_Paper_Knowledge_v0.2.md",
        "output": "00_GOVERNANCE/01_Product_Vision/01_FOUNDATION/Knowledge/SymK_Foundation_Paper_Knowledge_v0.2.pdf",
        "title": "Knowledge as the Shared Epistemic Medium",
        "subtitle": "A Foundation Paper for SymK",
        "accent": "176B87",
    },
    {
        "key": "intelligence",
        "source": "00_GOVERNANCE/01_Product_Vision/01_FOUNDATION/Intelligence/SymK_Foundation_Paper_Intelligence_v0.2.md",
        "output": "00_GOVERNANCE/01_Product_Vision/01_FOUNDATION/Intelligence/SymK_Foundation_Paper_Intelligence_v0.2.pdf",
        "title": "Intelligence Beyond the Human",
        "subtitle": "A Foundational Paper for SymK",
        "accent": "6A4C93",
    },
    {
        "key": "education",
        "source": "00_GOVERNANCE/01_Product_Vision/01_FOUNDATION/Education_and_Training/SymK_Foundation_Paper_Education_for_Cooperation_v0.2.md",
        "output": "00_GOVERNANCE/01_Product_Vision/01_FOUNDATION/Education_and_Training/SymK_Foundation_Paper_Education_for_Cooperation_v0.2.pdf",
        "title": "Formation, Education, and Training in SymK",
        "subtitle": "A Foundation Paper review draft",
        "accent": "A14C33",
    },
    {
        "key": "knowledge_engineering",
        "source": "00_GOVERNANCE/01_Product_Vision/01_FOUNDATION/Knowledge_Engineering/SymK_Foundation_Paper_Knowledge_Engineering_v0.2.md",
        "output": "00_GOVERNANCE/01_Product_Vision/01_FOUNDATION/Knowledge_Engineering/SymK_Foundation_Paper_Knowledge_Engineering_v0.2.pdf",
        "title": "Engineering Epistemic Conditions",
        "subtitle": "A Foundation Paper review draft for SymK",
        "accent": "2F6F5E",
    },
]
...
def publication_markdown(source: pathlib.Path, paper: dict[str, str]) -> str:
    ...
    yaml = [
        ...
        'date: "23 August 2026"',
        'lang: "en-US"',
        'subject: "Governed v0.2 Foundation Paper review draft; Stream G PDF projection"',
        'keywords: [SymK, Foundation Paper, Knowledge Engineering, governed review draft]',
        "---",
        "",
        "> **Publication status:** Stream G PDF projection of the governed, Stream F-integrated v0.2 Markdown review draft. Human review and publication acceptance remain pending.",
        "",
    ]
...
def create_reference_docx(path: pathlib.Path, accent: str, root: pathlib.Path) -> None:
    ...
    set_font(styles["Subtitle"], "Liberation Sans", 14, "53636B")
...
def build(root: pathlib.Path, work: pathlib.Path, *, resume: bool = False) -> None:
    ...
    for paper in PAPERS:
        ...
        if not (resume and output.exists() and pandoc_log.exists() and lo_log.exists()):
            create_reference_docx(reference_path, paper["accent"], root)
            run(
                [
                    "pandoc",
                    str(md_path),
    ...
    toolchain = {
        ...
        "projection_rule": "wide Markdown tables become stacked header-labelled records; governed Markdown remains unchanged",
    }
...
def main() -> int:
    ...
    build(args.root.resolve(), args.work.resolve(), resume=args.resume)
    return 0
