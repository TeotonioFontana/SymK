#!/usr/bin/env python3
"""Build the corrected SymK Foundation Paper review set as accessible PDF projections."""
...
PAPERS = [
    ...
    },
    {
        ...
        "source": "00_GOVERNANCE/01_Product_Vision/01_FOUNDATION/Reader_Orientation/SymK_Reader_Orientation_and_Shared_Glossary_v0.1.md",
        "output": "00_GOVERNANCE/01_Product_Vision/01_FOUNDATION/Reader_Orientation/SymK_Reader_Orientation_and_Shared_Glossary_v0.1.pdf",
...
def publication_markdown(source: pathlib.Path, paper: dict[str, str]) -> str:
    ...
    yaml = [
        ...
        'date: "24 August 2026"',
        'lang: "en-US"',
        'subject: "Governed Foundation Paper review draft; Stream H corrective projection"',
...
def separate_cover_from_contents(path: pathlib.Path) -> pathlib.Path:
    document = Document(path)
...
def build(root: pathlib.Path, work: pathlib.Path, *, resume: bool = False) -> None:
    ...
    for paper in PAPERS:
        ...
        if not (resume and output.exists() and pandoc_log.exists() and lo_log.exists()):
            ...
            docx_path = separate_cover_from_contents(docx_path)
