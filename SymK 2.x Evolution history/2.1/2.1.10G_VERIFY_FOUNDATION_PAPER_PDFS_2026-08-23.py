#!/usr/bin/env python3
"""Verify the four Stream G PDF projections and emit a controlled CSV record."""
...
def main() -> int:
    ...
    for paper, relative_stem in PAPERS:
        ...
        all_pages_text = all(len(text) >= 500 for text in extracted_pages)
        ...
        metadata_ok = (
            ...
            and metadata.subject == "Governed v0.2 Foundation Paper review draft; Stream G PDF projection"
        )
