# SymK 2.x Evolution History

**Status:** Active evolution-control workspace  
**Series:** SymK 2.x  
**Purpose:** Preserve the governed reasoning, evidence, decisions, dissent, and compatibility consequences through which SymK 2.x is consolidated
...
> **No material SymK 2.x conclusion shall appear only in a revised canonical document. Its question, sources, alternatives, reasoning, decision, dissent, consequences, and approval state must remain recoverable here.**
...
- `00_GOVERNANCE/` contains the current governed SymK corpus.
- This directory contains evolution history and stage control.
- Foundation Papers contain full conceptual inquiry.
