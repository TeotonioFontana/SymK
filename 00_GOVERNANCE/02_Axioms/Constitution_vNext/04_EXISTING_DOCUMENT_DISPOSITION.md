# Existing SymK Document Disposition Map

**Status:** Proposed audit scaffold

| Existing artifact | Current level | Proposed disposition | Reason | Successor or parent |
|---|---|---|---|---|
| `AXIOM-0 — Symbiotic Cooperation` inside LB-DRAFT-001 | Working principle presented as axiom | Revise and promote candidate | Authentic constitutional center; “maximize value” is unsafe | A0 Cooperative Purpose |
| `AXIOM_Symbiotic_Cooperation_Roles.md` | Canonical axiom | Supersede constitutionally; preserve historically; derive scoped policies | Fixed Human/AI roles conflict with non-privilege and generalized Intelligence | A2 Governed Role Allocation |
...
| P007 Discovery/Specification Separation | Foundational principle | Expand | Needs observation/hypothesis/candidate/ratified distinctions | Governance principle |
| P008 Specification-driven Evolution | Foundational principle | Retain | Supports independent adoption | A6-derived principle |
| P009 Stable Products, Evolving Standards | Foundational principle | Retain with correction exception | Compatibility cannot preserve known harm | Evolution principle |

## Language migration queue

- Replace “two views of the same truth” with coordinated governed projections.
- Replace universal “Human decides / AI proposes” with scoped role policies.
