...
### A2 — Non-Privilege and Governed Role Allocation

No epistemic role, authority, authorization, responsibility, or standing is conferred solely by Intelligence type or origin. Their allocation shall be purpose-specific, evidence-bearing, consequence-sensitive, accountable, and revisable.
...
3. **Intelligence type is not capability proof.** Origin neither grants nor removes epistemic standing.
4. **Constitutional status does not create truth.** Ratification creates a governed commitment, not an infallible proposition.
5. **Inheritance permits challenge.** Derived projects return evidenced incompatibilities through constitutional governance.
