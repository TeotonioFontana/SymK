...
## How durable change, Learning, Training and Education remain distinct
...
**Review lineage:** Stage-Accepted DR-013-018; Stream D `SYMK-2X-EV-164`; Stream F cross-paper integration `SYMK-2X-EV-166`; Stream H Human-reading corrections `SYMK-2X-EV-173` through `SYMK-2X-EV-177`  
...
| Concept | Predicate at issue | What does not establish it automatically | Separate questions |
|---|---|---|---|
| Formation | comparatively durable shaping or reorganization | exposure, architecture, purpose, activity, repetition, record | subject, mechanism, effect, direction, value, attribution |
| Learning | comparatively durable experience-linked change at a Learner level | output difference, retrieval, replacement, instruction, feedback | durability, linkage, manifestation, alternatives, current status |
| Instruction | guided formative activity | content delivery or instructor intent alone | access, reception, uptake, effect, authority |
| Training | directed structured formative activity toward declared conditions | repetition, industrial terminology, completed course | objective, structure, participation, success, transfer, decay |
| Education | broad integrated participatory challengeable Formation | schooling, credential, compliance, Training, architecture | Knowledge, judgment, conduct, relationship, frame revision, power |
| Socialization | Formation through social practices and expectations | membership or conformity alone | what order, whose norms, burdens, alternatives, challenge |
...
|---|---|
| Predicate | Is the claim about Formation, Learning, Instruction, Training, trained achievement, Education, Socialization, or another concept? |
| Subject | Which human, artificial, collective, institutional, distributed, or hybrid subject is claimed to bear the effect? |
| Boundary | What establishes the subject or Learner boundary and its continuity through change? |
| Time | Is the object an episode, activity, effect, continuing pattern, achievement, status, decay, or recovery? |
| Purpose | What developmental or performance condition was declared, by whom, and under what Authority? |
| Conditions | Which environment, exposure, practice, intervention, relationships, incentives, and constraints were material? |
| Mechanism | How is the effect linked to the conditions, and which alternatives remain plausible? |
| Manifestation | What changed at the claimed level under relevant variation? |
| Durability and transfer | Does the change persist, depend on support, and extend beyond the observed cases? |
| Power | Who could compel, refuse, contest, evaluate, revise, or exit, and what vulnerabilities mattered? |
| Affected horizon | Who participated, contributed, benefited, or bore burdens without participating? |
| Evidence | What Grounds and Evidence support each claim, with what uncertainty and dissent? |
| Views and loss | What do the Human, Scientific, and Engineering Views preserve or omit? |
| Status and lineage | Who assessed or authorized what, which procedure governs change, and when must the claim be reviewed? |
...
### 14.6 Detect failure, drift, and deskilling

Evaluation should distinguish Knowledge without enactment, enactment dependent on supervision, rule-following without transfer, compliance under coercion, local optimization that harms a wider system, habits persisting after their justification fails, capability decay, and deskilling through substitution.
...
| v0.1 question | Accepted minimum | Live remainder / owner |
|---|---|---|
| Can every Intelligence be educated? | Intelligence does not entail Education. Education requires its own subject-level Evidence; substrate alone does not decide. | Minimum literal attribution conditions across artificial, collective, distributed, and hybrid cases remain empirical, conceptual, Domain, and later standards work. |
| Is reflective capacity necessary? | Education includes capacity to examine and revise the frame; that capacity may be distributed rather than internal to each component. | How distributed reflection is realized and evidenced remains open by Domain and subject topology. |
| What distinguishes Education from successful Socialization? | Education is broad, integrated, participatory, and challengeable; Socialization may reproduce harmful orders. | Operational assessment remains Domain- and authority-sensitive. |
| Which habits are universal to SymK? | No universal virtue catalogue is accepted. Thin Cooperation and semantic non-substitutions control. | Domains may justify named dispositions; later constitutional work may consider narrower duties. |
| When is Training coercive? | Coercion, Training, consent, Authority, legitimacy, effect, and record are distinct. | Legal, professional, ethical, institutional, and Domain authorities own thresholds, permissions, protections, and remedies. |
| Can an institution be ill-mannered? | Institutions can bear relational, power, Formation, and possibly Learner predicates when supported at that level. | “Ill-mannered” remains contextual shorthand, not a universal technical status. |
| How should educational decay be represented? | Decay, drift, deskilling, unlearning, current status, and record are distinct and must remain visible. | Formal models, review periods, measures, and thresholds belong downstream. |
| Who educates the educator? | No formative position is semantically immune from Evidence, challenge, or competent review. | Actual governance bodies, standing, appeals, duties, remedies, and jurisdiction remain later or external decisions. |
...
- Aristotle. *Nicomachean Ethics*, especially Book II on virtue and habituation. [Perseus Digital Library](https://www.perseus.tufts.edu/hopper/text?doc=Perseus:text:1999.01.0054).
- Delors, J., et al. (1996). *Learning: The Treasure Within*. UNESCO. [UNESCO record](https://unesdoc.unesco.org/ark:/48223/pf0000109590).
- Dewey, J. (1916). *Democracy and Education*. Macmillan. [Project Gutenberg edition](https://www.gutenberg.org/ebooks/852).
- Dewey, J. (1922). *Human Nature and Conduct: An Introduction to Social Psychology*. Henry Holt. [Project Gutenberg edition](https://www.gutenberg.org/ebooks/41386).
- Durlak, J. A., Weissberg, R. P., Dymnicki, A. B., Taylor, R. D., and Schellinger, K. B. (2011). “The Impact of Enhancing Students' Social and Emotional Learning: A Meta-Analysis of School-Based Universal Interventions.” *Child Development*, 82(1), 405–432. [Publisher record](https://doi.org/10.1111/j.1467-8624.2010.01564.x).
- Fesmire, S. (2024). “John Dewey.” *Stanford Encyclopedia of Philosophy*. [Entry](https://plato.stanford.edu/entries/dewey/).
- Freire, P. (1970/2000). *Pedagogy of the Oppressed*. Continuum.
- Kohlberg, L. (1981). *The Philosophy of Moral Development*. Harper & Row.
- Lave, J., and Wenger, E. (1991). *Situated Learning: Legitimate Peripheral Participation*. Cambridge University Press. [Publisher record](https://doi.org/10.1017/CBO9780511815355).
- Mezirow, J. (1991). *Transformative Dimensions of Adult Learning*. Jossey-Bass.
- OECD. (2024). *Nurturing Social and Emotional Learning Across the Globe*. OECD Publishing. [Report](https://doi.org/10.1787/32b647d0-en).
- Phillips, D. C., Siegel, H., and Callan, E. (2024). “Philosophy of Education.” *Stanford Encyclopedia of Philosophy*. [Entry](https://plato.stanford.edu/entries/education-philosophy/).
- Ryle, G. (1949). *The Concept of Mind*. Hutchinson.
- Schön, D. A. (1983). *The Reflective Practitioner*. Basic Books.
- Vygotsky, L. S. (1978). *Mind in Society: The Development of Higher Psychological Processes*. Harvard University Press.
- Wenger, E. (1998). *Communities of Practice: Learning, Meaning, and Identity*. Cambridge University Press. [Publisher record](https://doi.org/10.1017/CBO9780511803932).
