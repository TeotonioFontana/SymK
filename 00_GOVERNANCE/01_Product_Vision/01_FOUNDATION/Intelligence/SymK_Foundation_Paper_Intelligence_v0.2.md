...
**Status:** Governed v0.2 Markdown review draft — conceptual reconstruction and Stream F cross-paper integration complete; Human review and publication acceptance pending  
**Version:** 0.2 review draft  
**Date:** 23 August 2026  
**Historical publication:** `SymK_Foundation_Paper_Intelligence_v0.1.md` and its PDF, preserved unchanged  
**Review lineage:** 2.1.3G and 2.1.3H early non-canonical review drafts; Stage-Accepted DR-011–018; Stream C `SYMK-2X-EV-163`; Stream F cross-paper integration `SYMK-2X-EV-166`  
**Scope:** Human-facing explanation of the accepted Intelligence concept, its evidence, boundaries, open questions, and engineering consequences
...
```text
observations, tests, failures, interventions, and counterevidence
...
| Tradition | Primary evidence/object | Durable contribution | Limit as universal definition | SymK use |
|---|---|---|---|---|
| psychometric *g* and hierarchical ability models | Human test covariance | latent-variable discipline; broad and narrow structure | population-, task-, culture-, and instrument-sensitive | Human capability evidence and assessment design |
| plural, practical, emotional, and social constructs | Domain-sensitive Human performance | profiles can preserve important differences hidden by one scalar | construct boundaries, overlap, and validation vary | candidate dimensions or specializations, not admission by name |
| developmental and sociocultural theories | change across development and mediation | developmental history, instruction, tools, transfer | primarily Human developmental models | formation and temporal evidence |
| rational-agent and symbolic traditions | action, objectives, search, representation | explicit environment, objective, inference, and consequence models | may collapse Intelligence toward Agency or optimization | bounded decision and reasoning projections |
| universal-machine Intelligence | policy performance across formal environments | breadth, goals, environments, priors | idealization and reward-centered assumptions | theoretical generality projection |
| skill-acquisition efficiency | performance relative to priors and experience | separates skill from acquisition/generalization efficiency | depends on declared Scope, priors, and benchmark construction | disclosure and learning-efficiency evidence |
| embodied, enactive, extended, and distributed cognition | coupled organism/system and environment | realization and boundary matter | boundary and constitutive claims remain disputed | mechanism and Bearer inquiry |
| collective Intelligence | coordinated group performance | possible system-level capacity beyond strongest member | aggregation can be mistaken for integration | collective-Bearer evidence, not automatic attribution |
...
| Area | Questions |
|---|---|
| proposed Bearer and boundary | Which organized system is claimed to bear Intelligence? Why are these components inside? |
| realization | Which substrate, organization, interfaces, dependencies, and continuity conditions matter? |
| actual claim | Which capacity or specialization is claimed, in which Scope and Context? |
| profile and Projection | Which dimensions are represented? What is omitted? How is any score or class produced? |
| variation and time | Which situations vary materially? Which cases were not individually specified? How long is the claim valid? |
| priors and resources | Which inheritance, design, training, Knowledge, tools, assistance, computation, access, and permissions were available? |
| Evidence | Which observations, repeated tests, failures, interventions, counterfactuals, and alternative explanations matter? |
| assessment and uncertainty | Who assessed what for which use, by what method, with which uncertainty and disagreement? |
| authority and use | Which competent source may authorize reliance or operation in this jurisdiction? |
| Responsibility and consequences | Who remains responsible? Who benefits or is affected? Which outcomes and consequences return for review? |
| challenge and revision | Who may challenge claims or decisions? Which competent procedure changes an artifact, status, authorization, or authority source? |
| lineage | Which versions, component changes, supersessions, and unresolved dissent must remain visible? |
...
| v0.1 question | Accepted minimum | Live remainder |
|---|---|---|
| minimum condition | exact multidimensional, integration, Context, material-variation, and non-individual-specification definition | thresholds and operational tests remain Domain-sensitive |
| whether Learning is necessary | no universal online-Learning requirement | Learning may be required by a specialization or assessment purpose |
| whether objectives are necessary | no universal fixed-objective requirement | objectives matter to some agentic and performance projections |
| how the Bearer is bounded | organized-system boundary, lowest adequate Bearer, integration and persistence Evidence | exact causal and identity criteria remain claim-sensitive |
| whether social systems can literally be intelligent | possible but not automatic | each claim requires system-level Evidence beyond aggregation |
| how much novelty is required | cases not individually specified and materially varying situations | operational distance measures remain Domain-sensitive |
| whether equivalent performance survives mechanism difference | equivalence is always scoped and does not transfer adjacent properties | robustness and mechanism-sensitive comparison remain empirical |
| relation to understanding | no automatic entailment | understanding may be a Knowledge mode, Intelligence dimension, both, or distinct |
| relation to consciousness | no automatic entailment | ethical inquiry is required if credible concern arises |
| persistent hybrid participant | possible under justified identity, integration, and continuity | component-change and succession criteria remain open |
| how claims age | temporal validity, versioning, challenge, restriction, and supersession are required | detailed aging rules belong to later standards |
| irreducible primitives | accepted Foundational concepts and supporting distinctions govern | final package anatomy, identifiers, and formal semantics remain downstream |
...
- Clark, A., and Chalmers, D. (1998). “The Extended Mind.” *Analysis*, 58(1), 7–19. [Publisher record](https://doi.org/10.1111/1467-8284.00096).
- Fodor, J. A. (1974). “Special Sciences (Or: The Disunity of Science as a Working Hypothesis).” *Synthese*, 28(2), 97–115. [Publisher record](https://doi.org/10.1007/BF00485230).
...
No implementation should silently promote the dimensions, specializations, review envelope, obligations, counterexamples, or development inventory into a canonical schema. No Human review, PDF correspondence, visual/accessibility approval, or publication decision is claimed by this Markdown review draft.
