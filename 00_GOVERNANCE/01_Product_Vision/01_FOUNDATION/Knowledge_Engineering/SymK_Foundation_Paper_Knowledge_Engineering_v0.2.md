...
## A Foundation Paper review draft for SymK
...
**Date:** 23 August 2026  
**Accepted baseline:** Stage-Accepted DR-009–018 and `2.1-rc.1`  
**Scope:** Human-facing explanation of Knowledge Engineering, its object, lifecycle, boundaries, controls, and development consequences  
**Lineage:** Reconstructs `SymK_Foundation_Paper_Knowledge_Engineering_v0.1.md` under Stream E `SYMK-2X-EV-165`; Stream F cross-paper integration `SYMK-2X-EV-166`; the v0.1 Markdown and PDF remain immutable historical evidence

---

## Abstract

Knowledge Engineering is Foundational to SymK, but it does not manufacture truth or Knowledge. It designs, constructs, governs, evaluates, and evolves **epistemic conditions**: arrangements of participants, processes, roles, resources, Representations, controls, environments, and feedback that materially affect how Knowledge is pursued, achieved, attributed, expressed, preserved, communicated, assessed, challenged, applied, and revised within declared Contexts and Scopes.

This distinction establishes the discipline's object and its limit. A claim, Document, model, graph, database, generated output, assessment, approval, or record does not become Knowledge through storage, structure, inference, Authority, adoption, or naming. Knowledge Engineering can enable, constrain, preserve, expose, or impair epistemic achievement. It cannot declare truth into existence or guarantee that any Bearer knows.

SymK inherits the historical discipline of expert systems, elicitation, model-based engineering, ontology engineering, Knowledge graphs, and machine-assisted construction. It also preserves what that history revealed: expertise is not a substance extracted from a container; every Representation is selective; formal correctness is local to premises and semantics; generative systems produce candidates rather than warrant; and deployment consequences return to inquiry without becoming Evidence automatically.

The paper presents a branching and recursive lifecycle, exact Representation and Projection boundaries, Human/Scientific/Engineering Views, typed Authority and Responsibility, the lowest-adequate-Bearer rule, and a non-container review envelope. Its earlier candidate commitments are retained as explanatory obligations, not constitutional propositions. Its requirements guide later design without defining a universal schema, workflow, ontology, metric, certification, or package.

> **Knowledge Engineering does not engineer truth or Knowledge directly. It engineers governed and evolvable epistemic conditions while preserving the difference among reality, Knowledge, claims, Grounds, Evidence, Representations, assessment, reliance, action, and consequence.**
...
Purpose / Context / Scope / Domain
        ...
        +-----------------------+
        v                       v
Questions <--> Inquiry      Participants / roles / practices
     |             \          /       |
     |              \        /        | contribute, observe, challenge
     v               v      v         v
Candidate claims <--- Grounds / possible-Evidence / Provenance
     |  \                 |                |
     |   \ represent      | assessed as    | locates lineage
     |    v               v                |
     |  Representations / Projections <----+
     |       |       \ 
     |       |        \ reasoning, retrieval, computation, generation
     |       v         v
     +--> Assessments / Answers / recommendations
                  |             |
                  | competent   | may inform, never entail
                  v             v
           Status / Reliance Authorization --> decisions / actions
                  ^                              |
                  |                              v
          challenge / review <--- observations / outcomes / consequences
                  |                              |
                  +--------- revision routes ---+
```
...
Data engineering governs acquisition, storage, transformation, quality, movement, and availability of represented observations or records. Information architecture governs organization and retrieval for users and tasks. Neither manages “facts” while Knowledge Engineering alone manages “meaning.” Their objects and criteria overlap but do not collapse.
...
| Review concern | Questions to preserve |
|---|---|
| Purpose and Value | What is being attempted, for whom, why, and under which competing Values and consequences? |
| Context, Scope, Domain | Where, when, for whom, and under which conditions does each claim or use apply? |
| Participants and affected subjects | Who contributes, interprets, assesses, decides, acts, bears burdens, benefits, or may challenge? |
| Bearer | Which lowest adequate Human, artificial, collective, institutional, distributed, hybrid, or configured system may know or learn? |
| Questions and claims | What is asked, asserted, denied, hypothesized, prescribed, recommended, or answered? |
| Grounds and Evidence | What can support or defeat which object; who attributes the Evidence role under which criteria? |
| Provenance | What are the origin, contribution, custody, transformations, versions, and omissions? |
| Representation and Projection | What is selected, added, omitted, strengthened, weakened, lost, reversible, or hard to recover? |
| Reasoning and tools | Which premises, methods, models, algorithms, judgments, and alternatives produce the result? |
| Assessment | Which Human, Scientific, and Engineering dimensions apply, and where do they disagree? |
| Authority and Responsibility | Who may propose, assess, authorize reliance, decide, act, change, supersede, or retire; who remains answerable? |
| Standing and challenge | Which standing/challenge locus applies, what response is owed by procedure, and what does not follow automatically? |
| Application | How can a Representation or result inform interpretation, recommendation, decision, action, or omission? |
| Consequences | What benefits, harms, burdens, displacement, dependencies, residuals, and unintended effects occurred? |
| Evolution | How are uncertainty, disagreement, correction, repair, versioning, supersession, decay, and retirement handled? |
| Formation and Learning | Which conditions existed, what subject-level effect is claimed, and which alternative explanations remain? |
...
| v0.1 inquiry | Accepted minimum | Live remainder |
|---|---|---|
| What is directly engineered? | Epistemic conditions, not truth or Knowledge directly. | Domain-specific object boundaries and implementation patterns. |
| Who or what can know? | Attribute at the lowest adequate Bearer under accepted Knowledge modes. | Evidence standards for difficult collective, distributed, artificial, and hybrid cases. |
| How should tacit Knowledge be handled? | Explicitization is selective transformation, not lossless extraction. | Domain practices for demonstration, apprenticeship, simulation, and capability preservation. |
| What counts as Evidence? | A role relative to a specified object, criteria, assessor, Context, Scope, and time. | Domain criteria, thresholds, and competent assessors. |
| Can one Representation suffice? | No universal form is selected; Projections declare loss. | Interoperability standards and task-specific adequacy. |
| How are Authority and challenge related? | Typed Authority remains distinct; standing/challenge is an unresolved locus; change follows competent procedure. | External rights, duties, remedies, and detailed challenge protocols. |
| How should consequences return? | Through observation, interpretation, inquiry, assessment, challenge, and governed revision routes. | Causal methods, monitoring thresholds, repair, and operational procedures. |
| What should participants or systems learn? | No universal Education or Learning requirement follows; any attribution needs subject-level Evidence. | Capability-continuity choices and Domain Formation requirements. |
...
Knowledge is an epistemic achievement attributable to an adequate Bearer, not the contents of a knowledge base. Claims, Grounds, Evidence, Provenance, Representations, computations, assessments, approvals, records, and consequences can contribute to Knowledge-related work without becoming interchangeable. Engineering acts materially on the conditions and transitions among them while remaining fallible, scoped, and challengeable.
...
- Feigenbaum, E. A. (1977). “The Art of Artificial Intelligence: Themes and Case Studies of Knowledge Engineering.” *Proceedings of IJCAI-77*. [Archival record](https://www.ijcai.org/Proceedings/77-2/Papers/092.pdf).
...
- Polanyi, M. (1966). *The Tacit Dimension*. Doubleday. [First-edition catalogue record](https://search.worldcat.org/title/374908).
